...
## 🚫 **DEPRECATED - Circuit Lab Removed from Build**

**The Circuit Lab simulation has been removed from the main build to streamline the site and focus on core, working simulations.**

### **Current Active Simulations:**
- **Fluid Dynamics** (Navier-Stokes real-time simulation)
- **Electrostatics** (Electric field visualization)
- **Wave Physics** (String and membrane wave equations)
- **Drag Rangefinder** (Projectile motion with air resistance)

### **What Was Circuit Lab:**
The Circuit Lab was an interactive circuit simulation featuring:
...
- Complexity affecting site performance
- Focus on core physics simulations
